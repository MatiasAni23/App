...
<style>.review-panel{padding:36px!important}.review-heading{display:flex;align-items:center;gap:18px;padding-bottom:26px;border-bottom:1px solid #dce3ed}.review-icon{width:64px;height:64px;flex:none;border-radius:50%;display:grid;place-items:center;background:var(--brand);color:#fff}.review-icon svg{width:34px;height:34px;fill:none;stroke:currentColor;stroke-width:1.8;stroke-linecap:round;stroke-linejoin:round}.review-heading h2{margin:0 0 8px;font-size:1.8rem;letter-spacing:-.025em}.review-heading p{margin:0;font-size:1.08rem;color:#334155}.review-heading p span{color:#16a36a;font-weight:800;margin-right:8px}.choice-intro{margin:28px 0 22px;color:#334155;font-size:1.05rem}.choice-intro span{color:var(--brand);font-weight:800;margin-right:9px}.edit-options{display:grid;grid-template-columns:repeat(2,minmax(0,1fr));gap:24px;align-items:stretch}.edit-choice{border:1px solid #d5dfeb;border-radius:18px;padding:26px;display:flex;flex-direction:column;min-height:100%;box-sizing:border-box;overflow:hidden}.choice-title{display:flex;align-items:center;gap:14px}.choice-number{width:54px;height:54px;display:grid;place-items:center;flex:none;border-radius:50%;background:var(--brand);color:#fff;font-size:1.45rem;font-weight:800}.choice-title h3{margin:0;font-size:1.25rem;line-height:1.25}.choice-content{display:grid;grid-template-columns:170px minmax(0,1fr);gap:16px;align-items:center;margin:24px 0 0;min-height:215px}.choice-content p{margin:0;color:#334155;line-height:1.55}.document-illustration-shell{position:relative;width:100%;max-width:170px;margin:0 auto;display:flex;align-items:center;justify-content:center}.document-illustration{width:100%;height:auto;display:block}.document-illustration-shell::after{content:"";position:absolute;right:-4px;bottom:-6px;width:54px;height:54px;border-radius:50%;background:#fff;border:3px solid #dfeaf6;box-shadow:0 10px 18px rgba(15,23,42,.12);background-image:url("/assets/Logo%20Drive.png");background-repeat:no-repeat;background-position:center;background-size:72%}.choice-action{margin-top:auto!important;display:block;width:100%}.edit-choice:first-child .choice-action{margin-top:26px!important}.choice-note{display:flex;gap:11px;align-items:flex-start;margin:18px 0 0;padding:15px 16px;border-radius:12px;background:var(--brand-soft);color:#294466;line-height:1.45;min-height:92px;box-sizing:border-box;width:100%}.choice-note svg{width:23px;height:23px;flex:none;stroke:#2774bd;stroke-width:2;fill:none}.choice-note strong{color:var(--brand-dark)}@media(max-width:760px){.review-panel{padding:24px!important}.review-heading{align-items:flex-start}.review-heading h2{font-size:1.4rem}.edit-options{grid-template-columns:1fr}.choice-content{grid-template-columns:120px 1fr}.review-icon{width:52px;height:52px}}</style>
<style>.edit-choice{display:grid;grid-template-rows:auto minmax(255px,1fr) auto auto;align-items:start}.choice-content{min-height:255px;align-items:center}.choice-action{align-self:stretch;margin-top:0!important}.choice-note{box-sizing:border-box;min-height:78px;align-items:center}</style>
{% if drive_url %}<section class="card review-panel"><div class="review-heading"><div class="review-icon"><svg viewBox="0 0 24 24" aria-hidden="true"><path d="M7 18.5h10.5a3.5 3.5 0 0 0 .4-7A5.8 5.8 0 0 0 7 9.3 4.6 4.6 0 0 0 7 18.5Z"></path><path d="M12 10v8"></path><path d="m9.5 12.5 2.5-2.5 2.5 2.5"></path></svg></div><div><h2>Contrato listo para revisión</h2><p><span>✓</span>El contrato fue guardado como documento editable en Google Drive.</p></div></div>{% if editor_configurado %}<p class="choice-intro"><span>ⓘ</span>Elige <strong>una</strong> de las siguientes opciones para <strong>realizar cambios</strong> en el contrato:</p>{% endif %}<div class="edit-options"><section class="edit-choice"><div class="choice-title"><span class="choice-number">1</span><h3>Editar en Google Drive</h3></div><div class="choice-content"><div class="document-illustration-shell"><svg class="document-illustration" viewBox="0 0 150 175" aria-hidden="true"><path d="M24 8h66l35 35v113a10 10 0 0 1-10 10H24a10 10 0 0 1-10-10V18A10 10 0 0 1 24 8Z" fill="#fff" stroke="#cbd5e1" stroke-width="3"></path><path d="M90 8v35h35" fill="#eef4fb" stroke="#cbd5e1" stroke-width="3"></path><path d="M35 69h60M35 86h48M35 103h57M35 120h42" stroke="#78a6d9" stroke-width="6" stroke-linecap="round"></path></svg></div><p>Realiza los cambios directamente en <strong>Google Drive</strong>. Luego descarga el documento como PDF y vuelve a este formulario para subirlo y enviarlo a firma.</p></div><a class="drive-button choice-action" href="{{ drive_url }}" target="_blank" rel="noopener">IR A GOOGLE DRIVE ↗</a><div class="choice-note"><svg viewBox="0 0 24 24"><circle cx="12" cy="12" r="9"></circle><path d="M12 10v6m0-9h.01"></path></svg><span>Después de editar, descarga el PDF y vuelve a este formulario para continuar.</span></div></section>{% if editor_configurado %}<section class="edit-choice"><div class="choice-title"><span class="choice-number">2</span><h3>Editar en el editor de documento</h3></div><div class="choice-content"><svg class="document-illustration" viewBox="0 0 150 175" aria-hidden="true"><path d="M24 8h66l35 35v113a10 10 0 0 1-10 10H24a10 10 0 0 1-10-10V18A10 10 0 0 1 24 8Z" fill="#fff" stroke="#cbd5e1" stroke-width="3"></path><path d="M90 8v35h35" fill="#eef4fb" stroke="#cbd5e1" stroke-width="3"></path><path d="M35 69h60M35 86h48M35 103h57M35 120h42" stroke="#78a6d9" stroke-width="6" stroke-linecap="round"></path><rect x="78" y="112" width="52" height="52" rx="4" fill="#fff" stroke="#4d8bd1" stroke-width="3" stroke-dasharray="5 4"></rect><text x="104" y="151" text-anchor="middle" font-size="42" font-family="Arial" fill="#163150">A</text></svg><p>Edita el contrato en nuestro editor integrado. Guarda los cambios y presiona <strong>Volver al formulario</strong>. El PDF se descargará automáticamente para que puedas enviarlo a firma.</p></div><a class="drive-button secondary choice-action" href="/contrato/editor/{{ registro_id }}">ABRIR EDITOR DE DOCUMENTO ✎</a><div class="choice-note"><svg viewBox="0 0 24 24"><circle cx="12" cy="12" r="9"></circle><path d="M12 10v6m0-9h.01"></path></svg><span>Al guardar, el PDF se descargará automáticamente. Luego podrás subirlo para la firma.</span></div></section>{% endif %}</div>{% if not editor_configurado %}<p class="hint">Editor de documentos no configurado. Puedes continuar editando desde Google Drive.</p>{% endif %}</section>{% endif %}
